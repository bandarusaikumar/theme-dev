...
$blog_columns = emall_get_theme_options('ts_blog_columns');
$extra_class  = 'columns-' . $blog_columns;

$default_posts_per_page = get_option( 'posts_per_page' );

$page_column_class = emall_page_layout_columns_class( apply_filters('emall_blog_page_layout', $page_options['ts_page_layout']) );
...
if( $show_breadcrumb || $show_page_title ){
	$extra_class .= ' show_breadcrumb_'.emall_get_theme_options('ts_breadcrumb_layout');
}

emall_breadcrumbs_title($show_breadcrumb, $show_page_title, get_the_title());
	...
	<div id="main-content">	
		<div id="primary" class="site-content">
			...
			<?php
				...
				$args = apply_filters('emall_blog_template_query_args', $args);
