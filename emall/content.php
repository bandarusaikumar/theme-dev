...
$blog_thumb_size = 'emall_blog_thumb';
...
<article <?php post_class( $post_class ) ?>>
	<?php if( $post_format != 'quote' ): ?>
		...
		<div class="entry-content <?php echo !$show_blog_thumbnail?'no-featured-image':'' ?>">
			...
			<?php if( $theme_options['ts_blog_columns'] == '1' && $theme_options['ts_blog_categories'] ): ?>
			...
			<?php if( $theme_options['ts_blog_columns'] != '1' && ($theme_options['ts_blog_date'] || $theme_options['ts_blog_author'] || $theme_options['ts_blog_comment'] || $theme_options['ts_blog_categories']) ): ?>
				<div class="entry-meta-top">
			...
			<?php if( $theme_options['ts_blog_columns'] == '1' && ($theme_options['ts_blog_date'] || $theme_options['ts_blog_author'] || $theme_options['ts_blog_comment']) ): ?>
				<div class="entry-meta-middle">
					...
					<?php if( $theme_options['ts_blog_date'] ) : ?>
						<span class="date-time"><span><?php esc_html_e('On ', 'emall'); ?></span><?php echo get_the_time( get_option('date_format') ); ?></span>
					<?php endif; ?>
			...
			<?php if( $theme_options['ts_blog_excerpt'] ): ?>
				...
				<div class="entry-summary">
					...
					<?php
						if( $max_words != '-1' ){
							emall_the_excerpt_max_words($max_words, $post, $strip_tags, '', true);
						}
			...
			<?php if( $theme_options['ts_blog_read_more'] ): ?>
				...
				<div class="readmore">
					<a class="button-text button-readmore" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more', 'emall'); ?></a>
				</div>
			<?php endif; ?>
